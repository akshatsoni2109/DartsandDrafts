...
public class DartThrowForTime : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (collision.gameObject.CompareTag("Dartboard"))
        {
            ...
            if (!hasHit)
            {
                ...
                FindAnyObjectByType<TimeScoreManager>().AddPoints(hitNumber);
                FindAnyObjectByType<TimeScoreManager>().UpdateMessage(hitNumber);
        ...
        else
        {
            ...
            {
                hasMissed = true;
                FindAnyObjectByType<TimeScoreManager>().UpdateMessage(0);
